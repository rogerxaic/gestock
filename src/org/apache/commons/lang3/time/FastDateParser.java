...
public class FastDateParser implements DateParser, Serializable {
    ...
    ic
    final Strategy NUMBER_MONTH_STRATEGY = new NumberStrategy(Calendar.MONTH) {
        @Override
    ...
    ic
    final Strategy WEEK_OF_YEAR_STRATEGY = new NumberStrategy(Calendar.WEEK_OF_YEAR);
    private stat
    /**
    ...
    ic
    final Strategy WEEK_OF_MONTH_STRATEGY = new NumberStrategy(Calendar.WEEK_OF_MONTH);
    private stat
    ...
    ic
    final Strategy DAY_OF_YEAR_STRATEGY = new NumberStrategy(Calendar.DAY_OF_YEAR);
    private stat
    ...
    ic
    final Strategy DAY_OF_MONTH_STRATEGY = new NumberStrategy(Calendar.DAY_OF_MONTH);
    private stat
    ...
    ic
    final Strategy DAY_OF_WEEK_IN_MONTH_STRATEGY = new NumberStrategy(Calendar.DAY_OF_WEEK_IN_MONTH);
    private stat
    ...
    ic
    final Strategy HOUR_OF_DAY_STRATEGY = new NumberStrategy(Calendar.HOUR_OF_DAY);
    private stat
    ...
    ic
    final Strategy HOUR24_OF_DAY_STRATEGY = new NumberStrategy(Calendar.HOUR_OF_DAY) {
        @Override
        int modify(final int iValue) {
    ...
    ic
    final Strategy HOUR12_STRATEGY = new NumberStrategy(Calendar.HOUR) {
        @Override
        int modify(final int iValue) {
    ...
    ic
    final Strategy HOUR_STRATEGY = new NumberStrategy(Calendar.HOUR);
    private stat
    ...
    ic
    final Strategy MINUTE_STRATEGY = new NumberStrategy(Calendar.MINUTE);
    private stat
    ...
    ic
    final Strategy SECOND_STRATEGY = new NumberStrategy(Calendar.SECOND);
    private stat
    ...
    ic
    final Strategy MILLISECOND_STRATEGY = new NumberStrategy(Calendar.MILLISECOND);
    private stat
    ...
    private stic
    final Strategy ISO_8601_STRATEGY = new ISO8601TimeZoneStrategy("(Z|(?:[+-]\\d{2}(?::?\\d{2})?))");
